...
page = st.sidebar.radio("Navigation", ["Dashboard", "Review report", "Sounding Board", "History", "Company standards", "Plans & setup"], label_visibility="collapsed")
...
Photos should support major defects and completed repairs.""")
    ...
    page_header("Plans and commercial setup", "Indicative usage tiers and production requirements for a commercial rollout.", "Commercial")
