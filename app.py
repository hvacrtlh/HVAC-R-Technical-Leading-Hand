...
page = st.sidebar.radio("Navigation", ["Dashboard", "Review report", "Sounding Board", "History", "Company standards", "Plans & setup"])
...
if page == "Dashboard":
    ...
    st.caption("Describe the symptoms")
    ...
    question = st.chat_input("Describe the symptoms or ask a technical question...")
    if question:
